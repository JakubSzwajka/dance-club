...
class CustomUserAdmin(UserAdmin, ModelAdmin):
    list_display = ('avatar_display', 'email', 'get_full_name', 'role', 'is_active', 'is_staff', 'date_joined')
    ...
    def avatar_display(self, obj):
        ...
        return format_html(
            ...
            '</div>',
            obj.get_initials() if hasattr(obj, 'get_initials') else obj.email[0].upper()
        )
