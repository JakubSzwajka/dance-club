...
export function LocationReviewBlock({ onSubmit, onSkip, onBack, locationId, isActive }: LocationReviewBlockProps) {
    ...
    <Card className="p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Rate the facilities and comfort of the dance studio</p>
        </div>
      </div>
