...
export function ClassSchedulePage() {
  const { classId } = useParams({
    from: '/instructor-panel/instructor-panel/classes/$classId/schedule',
  })
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Manage the schedule for this class</p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set the class duration and weekly schedule</CardDescription>
            </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>When the class starts</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Set the weekly recurring schedule</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Preview how your schedule will look</CardDescription>
            </CardHeader>
            <CardContent>
