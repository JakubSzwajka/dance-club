...
export interface paths {
    ...
    "/api/public/locations/nearby": {
         ...
         * @description Get locations, optionally filtered to those with active classes
         */
        get: operations["mydanceclub_api_public_locations_get_locations_nearby"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    ...
    mydanceclub_api_public_classes_get_class_stats: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ReviewAggregatedDanceClassStatsSchema"];
                };
            };
        };
    };
    ...
    mydanceclub_api_public_instructors_get_instructor_stats: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ReviewAggregatedInstructorStatsSchema"];
                };
            };
        };
    };
    ...
    mydanceclub_api_public_locations_get_locations_nearby: {
        parameters: {
            query?: {
                has_active_classes?: boolean;
                latitude?: number | null;
    ...
    mydanceclub_api_public_locations_get_location_stats: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ReviewAggregatedLocationStatsSchema"];
                };
            };
        };
    };
